...
input[type=checkbox] {
  ...
  /* Border Radius */
  border-radius: var(--border-radius-m, 10rem);
  &.border-radius-none { border-radius: 0 }
  &.border-radius-s { border-radius: var(--border-radius-s, 6rem) }
  &.border-radius-l { border-radius: var(--border-radius-l, 10rem) }
  &.border-radius-full { border-radius: var(--border-radius-full, 10rem) }
